...
new Vue({
  ...
  methods: {
    ...
    getJsonImages() {
      fetch("../../../lib-native/madinet_elma3refa/assets/json/images.json")
        .then((res) => {
          if (!res.ok) {
    ...
    getvalues() {
      ...
      this.clickDoorAudio.src =
        "../../../lib-native/madinet_elma3refa/assets/audio/clickdoor.mp3";
      this.doorAudio.src =
        "../../../lib-native/madinet_elma3refa/assets/audio/door.mp3";
      this.bgAudio.src =
        "../../../lib-native/madinet_elma3refa/assets/audio/music.mp3";
      ...
      this.readAudio.src =
        "../../../lib-native/madinet_elma3refa/assets/audio/read.mp3";
      this.lampAudio.src =
        "../../../lib-native/madinet_elma3refa/assets/audio/lamp.mp3";
      this.helpAudio.src =
        "../../../lib-native/madinet_elma3refa/assets/audio/help.mp3";
      this.warningAudio.src =
        "../../../lib-native/madinet_elma3refa/assets/audio/warning.mp3";
      this.starAudio.src =
        "../../../lib-native/madinet_elma3refa/assets/audio/star.mp3";
      this.wrongPun.src =
        "../../../lib-native/madinet_elma3refa/assets/audio/error.mp3";
    ...
    wrongAnswerSelect() {
      ...
      this.wrongAudio.src =
        "../../../lib-native/madinet_elma3refa/assets/audio/feedbackwrong/select.mp3";
      ...
      var aduioListener = function () {
        ...
        mythis.showSelectAudio.src =
          "../../../lib-native/madinet_elma3refa/assets/audio/lampSelect.mp3";
    ...
    soundTrue() {
      ...
      this.correctAudio.src =
        "../../../lib-native/madinet_elma3refa/assets/audio/feedbackcorrect/0" +
    ...
    soundFalse() {
      ...
      this.UpdateStudentActivity();
      this.wrongAudio.src =
        "../../../lib-native/madinet_elma3refa/assets/audio/feedbackwrong/0" +
    ...
    getTitle(type) {
      setTimeout(() => {
        ...
        this.questionAudio.src =
          "../../../lib-native/madinet_elma3refa/assets/audio/q/q" +
          type +
          ".mp3";
