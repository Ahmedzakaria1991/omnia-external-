...
new Vue({
  ...
  methods: {
    ...
    getJsonImages() {
      fetch("../../../lib-native/soltan/assets/json/images.json")
        .then((res) => {
          if (!res.ok) {
    ...
    getvalues() {
      ...
      this.clickDoorAudio.src =
        "../../../lib-native/soltan/assets/audio/clickdoor.mp3";
      this.doorAudio.src = "../../../lib-native/soltan/assets/audio/door.mp3";
      this.bgAudio.src = "../../../lib-native/soltan/assets/audio/music.mp3";
      ...
      this.readAudio.src = "../../../lib-native/soltan/assets/audio/read.mp3";
      this.lampAudio.src = "../../../lib-native/soltan/assets/audio/lamp.mp3";
      this.helpAudio.src = "../../../lib-native/soltan/assets/audio/help.mp3";
      this.warningAudio.src =
        "../../../lib-native/soltan/assets/audio/warning.mp3";
      this.starAudio.src = "../../../lib-native/soltan/assets/audio/star.mp3";
      this.wrongPun.src = "../../../lib-native/soltan/assets/audio/error.mp3";
    ...
    wrongAnswerSelect() {
      ...
      this.wrongAudio.src =
        "../../../lib-native/soltan/assets/audio/feedbackwrong/select.mp3";
      ...
      var aduioListener = function () {
        ...
        mythis.showSelectAudio.src =
          "../../../lib-native/soltan/assets/audio/lampSelect.mp3";
    ...
    soundTrue() {
      ...
      this.correctAudio.src =
        "../../../lib-native/soltan/assets/audio/feedbackcorrect/0" +
    ...
    soundFalse() {
      ...
      this.UpdateStudentActivity();
      this.wrongAudio.src =
        "../../../lib-native/soltan/assets/audio/feedbackwrong/0" +
    ...
    getTitle(type) {
      setTimeout(() => {
        ...
        this.questionAudio.src =
          "../../../lib-native/soltan/assets/audio/q/q" + type + ".mp3";
