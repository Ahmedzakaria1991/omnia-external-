var DragAndDrop = document.querySelector("#DragAndDropRearrange");
var pageUrl = DragAndDrop.getAttribute("data-urlpage");
var numOfPointer = [];

new Vue({
  el: "#DragAndDropRearrange",
  data: {
    posts: [
      {
        nameId: "",
  ...
  methods: {
    ...
    background: function () {
      ...
      question.innerHTML += `<svg class="landscape" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" 
            xmlns:xlink="http://www.w3.org/1999/xlink" 
            x="0px" y="0px" viewBox="0 0 1500 1004" style="enable-background:new 0 0 1500 1004;"
             xml:space="preserve"><g><g><path :style="{fill : this.posts[0].colorTemplate}"
              class="st0" d="M0,398.3c0,0,93.6,107.2,58.8,277.5C23,851.2,54.9,976.9,155.9,974c101-2.9,454.4-62.2,672.1,30H0V398.3z"/>
              <g><g><rect x="27.2" y="753.3"  class="st1" width="1.6" height="4.8"/></g><g><path
                class="st1" d="M28.8,743.6h-1.6v-9.7h1.6V743.6z M28.8,724.3h-1.6v-9.7h1.6V724.3z M28.8,704.9h-1.6v-9.7h1.6V704.9
                z M28.8,685.5h-1.6v-9.7h1.6V685.5z M28.8,666.1h-1.6v-9.7h1.6V666.1z M28.8,646.8h-1.6v-9.7h1.6V646.8z M28.8,627.4h-1.6v-9.7h1.6V627.4z 
                M28.8,608h-1.6v-9.7h1.6V608z M28.8,588.6h-1.6v-9.7h1.6V588.6z M28.8,569.3h-1.6v-9.7h1.6V569.3z M28.8,549.9h-1.6v-9.7h1.6V549.9z
                 M28.8,530.5h-1.6v-9.7h1.6V530.5z M28.8,511.1h-1.6v-9.7h1.6V511.1z M28.8,491.8h-1.6v-9.7h1.6V491.8z M28.8,472.4h-1.6v-9.7h1.6V472.4z
                  M28.8,453h-1.6v-9.7h1.6V453z M28.8,433.6h-1.6v-9.7h1.6V433.6z M28.8,414.3h-1.6v-9.7h1.6V414.3z M28.8,394.9h-1.6v-9.7h1.6V394.9
                  z M28.8,375.5h-1.6v-9.7h1.6V375.5z M28.8,356.1h-1.6v-9.7h1.6V356.1z M28.8,336.8h-1.6v-9.7h1.6V336.8z M28.8,317.4h-1.6v-9.7h1.6V317.4z 
                  M28.8,298h-1.6v-9.7h1.6V298z M28.8,278.6h-1.6v-9.7h1.6V278.6z M28.8,259.3h-1.6v-9.7h1.6V259.3z M28.8,239.9h-1.6v-9.7h1.6V239.9z M28.8,220.5h
                  -1.6v-9.7h1.6V220.5z M28.8,201.1h-1.6v-9.7h1.6V201.1z M28.8,181.8h-1.6v-9.7h1.6V181.8z M28.8,162.4h-1.6v-9.7h1.6V162.4z"/></g></g><g>
                  <circle class="st1" cx="28" cy="144" r="5"/></g><g>
                  <path  class="st1" d="M727.3,973.1h-9.7v-1.6h9.7V973.1z M707.9,973.1h-9.7v-1.6h9.7V973.1z M688.6,973.1h-9.7v-1.6h9.7V973.1z M669.3,973.1h-9.7v-1.6
                  h9.7V973.1z M649.9,973.1h-9.7v-1.6h9.7V973.1z M630.6,973.1h-9.7v-1.6h9.7V973.1z M611.3,973.1h-9.7v-1.6h9.7V973.1z M591.9,973.1h-9.7v-1.6h9.7V973.1z M572.6,973.1h-9.7v-1.6h9
                  .7V973.1z M553.3,973.1h-9.7v-1.6h9.7V973.1z M533.9,973.1h-9.7v-1.6h9.7V973.1z M514.6,973.1H505v-1.6h9.7V973.1z M495.3,973.1h-9.7v-1.6h9.7V973.1z
                   M476,973.1h-9.7v-1.6h9.7V973.1z M456.6,973.1H447v-1.6h9.7V973.1z M437.3,973.1h-9.7v-1.6h9.7V973.1z M418,973.1h-9.7v-1.6h9.7V973.1z M398.6,973.1H389v-1
    ...
    dragLength() {
      ...
      this.posts[0].droggableBox.forEach((el) => {
        this.posts[0].dragCounter += el.items.length;
      });
    ...
    getUnits: async function () {
      ...
      function sound_true() {
        ...
        // --------------------------------------------------------
        direction != ""
          ? ((posts.nameId = "DragAndDropRearrange"),
    ...
    confirm: function (ui) {
      ...
      fetch("../json/" + pageUrl + ".json")
        ...
        .then((data) => {
          ...
          this.dragLength();
          direction != "" ?
            (globalFunctions.UpdateStudentActivity(this.activityId, this.posts[0], true, true)) :
            "";
     ...
     relaod: async function () {
      this.posts[0].subject.includes("eng")
      ? $( ".resetText" ).append( "<p>Do you wish to delete the previous recordings?</p>" )
      ...
      : $( ".no" ).append( "لا" )
      if (direction == "2") {
        if (this.data.learningObjectAsJson != "" &&
          this.data.learningObjectAsJson != null) {
          if (JSON.parse(this.data.learningObjectAsJson).pointCorrect.length != 0) {
            document.querySelectorAll('.droppable').forEach(element => {
              numOfPointer  = JSON.parse(this.data.learningObjectAsJson).pointCorrect
              JSON.parse(this.data.learningObjectAsJson).pointCorrect.forEach(el => {
                ...
                document.querySelectorAll('.draggable').forEach(ele => {
                  if(el == ele.getAttribute("data-number") && ele.getAttribute("data-number") == element.getAttribute("data-number")){
                     element.append(ele.childNodes[0])
                     ele.childNodes[1] != undefined? element.append(ele.childNodes[1]) : ""
