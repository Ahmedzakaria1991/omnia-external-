  ...
  methods: {
    ...
    dragLength() {
      this.posts[0].daragSlid.forEach((el, index) => {
        this.posts[0].dragCounter += el.droggableBox.length;
      });
    ...
    shuffle: async function () {
      let numbers = [...this.posts[0].daragSlid[0].droggableBox];
    ...
    shuffledQ: async function () {
      ...
      // console.log(this.posts[0].daragSlid.length)
    },
