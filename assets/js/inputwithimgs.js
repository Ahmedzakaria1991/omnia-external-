var inputValidation = document.querySelector("#inputwithimgs");
...
new Vue({
  ...
  methods: {
    ...
    sound_true: function () {
      ...
      this.posts[0].endTime = this.getDate();
      direction != ""
        ? ((this.posts[0].nameId = "inputwithimgs"),
