var choose = document.querySelector("#multipleTemp");
...
new Vue({
  ...
  methods: {
      ...
      !this.dataLoaded
        ? await fetch("../json/" + pageUrl + ".json")
            ...
            .then((data) => {
              ...
              this.posts[0].numberOfquestion = this.posts[0].quizChooses.length;
    ...
    clearChecked() {
      this.posts[0].quizChooses.forEach((el) => {
