var Conect = document.querySelector("#Conect");
...
new Vue({
  ...
  methods: {
    ...
    dragStart(ev) {
      ...
      this.Conect = document.getElementById("Conect");
      if (
        this.Conect.classList.contains("eng")||
        this.Conect.classList.contains("eng-4")||
        this.Conect.classList.contains("eng-5")||
        this.Conect.classList.contains("eng-6")
      ) {
        if (ev.target.classList.contains("flip")) {
          this.line.setAttribute("x1", rect.left);
          this.line.setAttribute("y1", rect.top + ev.target.clientHeight / 2);
          this.line.setAttribute("x2", rect.left);
          this.line.setAttribute("y2", rect.top + ev.target.clientHeight / 2);
        } else {
          this.line.setAttribute("x1", ev.target.clientWidth + rect.left);
          this.line.setAttribute("y1", rect.top + ev.target.clientHeight / 2);
          this.line.setAttribute("x2", ev.target.clientWidth + rect.left);
          this.line.setAttribute("y2", rect.top + ev.target.clientHeight / 2);
        }
      } else {
        if (ev.target.classList.contains("flip")) {
    ...
    dragOver(ev) {
      ...
      this.line.setAttribute("y2", ev.offsetY + ev.pageY);
    },
     dragEnd(ev, drag) {
      ...
      if (this.dropID == this.dragID) {
        ...
        if (
          ...
          if (dropZone.classList.contains("flip")) {
            this.endX = rect.left;
            this.endY = rect.top + dropZone.clientHeight / 2;
            this.line.setAttribute("x2", this.endX);
            this.line.setAttribute("y2", this.endY);
          } else {
            this.endX = rect.left + dropZone.clientWidth;
            this.endY = rect.top + dropZone.clientHeight / 2;
            this.line.setAttribute("x2", this.endX);
            this.line.setAttribute("y2", this.endY);
          }
    ...
    touchStart(ev) {
      ...
      if (
        ...
        if (ev.target.classList.contains("flip")) {
          this.line.setAttribute("x1", rect.left);
          this.line.setAttribute("y1", rect.top + rect.height / 2);
          this.line.setAttribute("x2", rect.left);
          this.line.setAttribute("y2", rect.top + rect.height / 2);
        } else {
          this.line.setAttribute("x1", rect.width + rect.left);
          this.line.setAttribute("y1", rect.top + rect.height / 2);
          this.line.setAttribute("x2", rect.width + rect.left);
          this.line.setAttribute("y2", rect.top + rect.height / 2);
        }
      } else {
        if (ev.target.classList.contains("flip")) {
    ...
    dropMobile(dropZone, drag, ev) {
      ...
      if (this.dropID == this.dragID) {
        ...
        if (
          ...
          if (ev.target.classList.contains("flip")) {
            this.endX = rect.left + rect.width;
    ...
    updateCreateLine(id, divRight, divLeft) {
      ...
      if (
        ...
        this.line.setAttribute("x1", divRight.left + divRight.width);
        this.line.setAttribute("y1", divRight.top + divRight.height / 2);
        this.line.setAttribute("x2", divLeft.left);
        this.line.setAttribute("y2", divLeft.top + divLeft.height / 2);
      } else {
        this.line.setAttribute("x1", divLeft.left + divLeft.width);
        this.line.setAttribute("y1", divLeft.top + divLeft.height / 2);
        this.line.setAttribute("x2", divRight.left);
        this.line.setAttribute("y2", divRight.top + divRight.height / 2);
      }
      this.svg.appendChild(this.line);
      var sv = document.getElementsByClassName("svg-dist")[0];
      sv.appendChild(this.svg);
