...
new Vue({
  ...
  methods: {
    ...
    shuffle: function () {
      let numbers = [...this.posts[0].droggableBox[0].items];
      let first,
        second,
        temp,
        count = numbers.length;
      for (let i = 0; i <= this.posts[0].droggableBox[0].items.length; i++) {
